...
export const meta: MetaFunction<typeof loader> = () => {
  return [
    ...
    {description: 'Privacy at GoodWatch. All movie and tv show ratings and streaming providers on the same page'},
  ]
}
  ...
  return (
    <div className="max-w-7x mx-auto px-8 lmt-0 py-2 md:py-4 lg:py-8">
      ...
      <p>The words of which the initial letter is capitalized have meanings defined under the following conditions. The
        ...
        plural.</p>
      <h3 className="mt-8 mb-2 text-xl font-bold">Definitions</h3>
      ...
      <ul>
        ...
        <li>
          <p><strong>Company</strong> (referred to as either &quot;the
            Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to GoodWatch.</p>
        </li>
        <li>
      ...
      <h2 className="mt-12 mb-4 text-2xl font-bold">Collecting and Using Your Personal Data</h2>
      <h3 className="mt-8 mb-2 text-xl font-bold">Types of Data Collected</h3>
      <h4>Personal Data</h4>
      ...
      <h3 className="mt-8 mb-2 text-xl font-bold">Use of Your Personal Data</h3>
      ...
      <h3 className="mt-8 mb-2 text-xl font-bold">Retention of Your Personal Data</h3>
      ...
      <h3 className="mt-8 mb-2 text-xl font-bold">Transfer of Your Personal Data</h3>
      ...
      <p>The Company will take all steps reasonably necessary to ensure that Your data is treated securely and in
        ...
        information.</p>
      <h3 className="mt-8 mb-2 text-xl font-bold">Delete Your Personal Data</h3>
      ...
      <p>Please note, however, that We may need to retain certain information when we have a legal obligation or lawful
        basis to do so.</p>
      <h3 className="mt-8 mb-2 text-xl font-bold">Disclosure of Your Personal Data</h3>
      ...
      <h3 className="mt-8 mb-2 text-xl font-bold">Security of Your Personal Data</h3>
      ...
      <h2 className="mt-12 mb-4 text-2xl font-bold">Children's Privacy</h2>
      ...
      <h2 className="mt-12 mb-4 text-2xl font-bold">Links to Other Websites</h2>
      ...
      <h2 className="mt-12 mb-4 text-2xl font-bold">Changes to this Privacy Policy</h2>
      ...
      <h2 className="mt-12 mb-4 text-2xl font-bold">Contact Us</h2>
      <p>If you have any questions about this Privacy Policy, You can contact us:</p>
      <ul>
        <li>By email: hello@goodwatch.app</li>
      </ul>
    </div>
  );
}
