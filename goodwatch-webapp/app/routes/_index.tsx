					...
					<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 300 800">
						...
						<defs>
							...
							>
								<stop
									offset="0%"
									style={{ stopColor: "#55a", stopOpacity: 1 }}
								/>
								<stop
									offset="100%"
									style={{ stopColor: "#338", stopOpacity: 1 }}
								/>
							</linearGradient>
							...
							>
								<stop
									offset="0%"
									style={{ stopColor: "#E50914", stopOpacity: 1 }}
								/>
								<stop
									offset="100%"
							...
							<linearGradient id="prime-grad" x1="0%" y1="0%" x2="0%" y2="100%">
								<stop
									offset="0%"
									style={{ stopColor: "#00A8E1", stopOpacity: 1 }}
								/>
								<stop
									offset="100%"
							...
							>
								<stop
									offset="0%"
									style={{ stopColor: "#113CCF", stopOpacity: 1 }}
								/>
								<stop
									offset="100%"
							...
							<radialGradient id="power-glow">
								<stop
									offset="0%"
									style={{ stopColor: "#ff3b30", stopOpacity: 1 }}
								/>
								<stop
									offset="100%"
