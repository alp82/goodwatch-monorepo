...
export const meta: MetaFunction = () => {
	const pageMeta: PageMeta = {
		...
		description:
			"Legal disclaimer and impressum for GoodWatch",
		url: "https://goodwatch.app/disclaimer",
		image: "https://goodwatch.app/images/heroes/hero-movies.png",
		alt: "GoodWatch Disclaimer",
	};
...
export default function Disclaimer() {
	return (
		<div className="flex flex-col items-center mt-0 py-2 md:py-4 lg:py-8">
			...
			<section className="prose prose-invert lg:prose-xl mx-auto">
				<p>
					The information provided by GoodWatch (“we,” “us” or “our”) on
					goodwatch.com (the “Site”) is for general informational purposes only.
