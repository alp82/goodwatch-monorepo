// "VHS shelf": a video-store staff-picks shelf. #1–#3 stand face-out in
...
function Clamshell({ item, rank, t }: { item: CardTitle; rank: number; t: Theme }) {
	const art = BOX_W - 16
	const artH = BOX_H - 16
	return (
...
function ShelfLabel({ item, rank, t }: { item: CardTitle; rank: number; t: Theme }) {
	return (
...
export const vhs: CardDesign = { key: "vhs", name: "VHS shelf", format: "Post 4:5", w: W, h: H, Card: VhsCard }
