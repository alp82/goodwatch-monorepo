// "Trading cards": the list as a set of collectible cards. #1 is the
...
function Collectible({ item, rank, total, t, w, name, date }: { item: CardTitle; rank: number; total: number; t: Theme; w: number; name: string; date: string }) {
	const k = w / HERO_W
...
export const trading: CardDesign = { key: "trading", name: "Trading cards", format: "Story 9:16", w: W, h: H, Card: TradingCard }
