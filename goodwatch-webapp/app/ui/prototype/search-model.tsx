// THROWAWAY: preserved balanced blend and highlighting from the accepted combined-search prototype.
import type { runCombinedDescription } from "~/server/prototype-combined-d4.server"
export type Title = {
	id: number
	title: string
	original?: string
...
export type Description = Awaited<ReturnType<typeof runCombinedDescription>>
const examples = [
	"Heat",
	"Drive",
	"Her",
	"like Game of Thrones, but sci-fi",
	"Tom Hanks",
	"Incepton",
	"Game of Th",
	"tense but not bleak",
