...
export default function Checkbox<T extends CheckOption>({
	...
	return (
		<div className="flex items-center ps-4 border bg-gray-800/50 border-gray-700 rounded-sm">
			<input
				id={name}
				type="checkbox"
		...
		// 			className="size-4 rounded-sm border-gray-300 text-indigo-600 focus:ring-indigo-600"
		// 			onChange={handleChange}
		// 		/>
		// 	</div>
