// PROTOTYPE - throwaway. Shared building blocks for share-list card designs.
//
...
//   empty ranks up to the design's max. Never render placeholders when exporting.
// - resvg panics (and takes the server down) on some inputs: negative sizes, a zero-height box
//   with a dashed border, a blurred boxShadow on a rotated parent. Test renders in a separate process.
...
export const kind = (i: ListItem) => (i.type === "movie" ? "Movie" : "Series")
