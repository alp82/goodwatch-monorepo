// PROTOTYPE - throwaway. "Front page": a broadsheet front page. The list title is the banner
...
function Photo({ item, w, h, ink, slot, poster }: { item: ListItem; w: number; h: number; ink: string; slot: number; poster?: boolean }) {
...
export const newsprint: Design = { key: "newsprint", name: "Front page", format: "Post 4:5", w: W, h: H, max: 5, Card: NewsprintCard }
