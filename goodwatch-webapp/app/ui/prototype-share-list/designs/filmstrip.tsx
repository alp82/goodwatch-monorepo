// PROTOTYPE - throwaway. "Film strip": a 35mm negative strip laid on a glowing light table.
...
export const filmstrip: Design = { key: "filmstrip", name: "Film strip", format: "Story 9:16", w: W, h: H, max: 5, Card: FilmstripCard }
