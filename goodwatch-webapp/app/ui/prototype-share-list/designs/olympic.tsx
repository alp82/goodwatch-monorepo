// PROTOTYPE - throwaway. "Ceremony": a premium awards presentation. Black marble plinths in 2-1-3
...
const Framed = ({ item, w, slot, t, style }: { item: ListItem; w: number; slot: number; t: Theme; style?: CSSProperties }) => {
...
export function OlympicCard({ title, items, name, theme, date, editing }: CardProps) {
...
export const olympic: Design = { key: "olympic", name: "Ceremony", format: "Story 9:16", w: W, h: H, max: 5, Card: OlympicCard }
