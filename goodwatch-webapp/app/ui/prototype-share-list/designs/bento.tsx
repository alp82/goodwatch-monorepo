// PROTOTYPE - throwaway. "Bento": a square grid of rounded tiles. #1 gets the big backdrop tile,
...
const Art = ({ src, w, h, item, t }: { src: string | null; w: number; h: number; item: ListItem; t: Theme }) =>
	src ? (
...
function RankTile({ item, rank, w, h, t, wide }: { item: ListItem; rank: number; w: number; h: number; t: Theme; wide: boolean }) {
...
function HeroTile({ item, t }: { item: ListItem; t: Theme }) {
...
function statTiles(items: ListItem[]) {
...
export const bento: Design = { key: "bento", name: "Bento", format: "Square 1:1", w: S, h: S, max: 5, Card: BentoCard }
