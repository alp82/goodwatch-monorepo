// PROTOTYPE - throwaway. "Tickets": each pick is a cinema ticket stub, fanned down a dark lobby
...
import { type CardProps, type Design, hash, THEMES } from "../model"
...
export const tickets: Design = { key: "tickets", name: "Tickets", format: "Story 9:16", w: W, h: H, max: 5, Card: TicketsCard }
