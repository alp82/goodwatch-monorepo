// PROTOTYPE - throwaway. "Manifesto": a bold typographic poster on a full-bleed theme color.
...
const Cell = ({ item, n, w, h, t, tab }: { item: ListItem; n: number; w: number; h: number; t: Theme; tab: number }) => (
...
export function SwissCard({ title, items, name, theme, date, editing }: CardProps) {
...
export const swiss: Design = { key: "swiss", name: "Manifesto", format: "Post 4:5", w: W, h: H, max: 5, Card: SwissCard }
