// PROTOTYPE - throwaway. "Letterboard": an oak-framed felt letter board hung on a wall, lit from
...
import { type CardProps, type Design, THEMES } from "../model"
...
export const letterboard: Design = { key: "letterboard", name: "Letterboard", format: "Square 1:1", w: S, h: S, max: 5, Card: LetterboardCard }
