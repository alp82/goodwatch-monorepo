// PROTOTYPE - throwaway. "Teletext": a 1980s teletext page. Page header with clock, a mosaic
...
export const teletext: Design = { key: "teletext", name: "Teletext", format: "Post 4:5", w: W, h: H, max: 5, Card: TeletextCard }
