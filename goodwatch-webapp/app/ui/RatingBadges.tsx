    ...
    <div className="relative">
      ...
      <ul className={`underline-offset-2 flex flex-wrap gap-2 sm:gap-6  ${isComplete ? '' : 'opacity-50'}`}>
        ...
        <a className="" href={ratings?.metacritic_url} target="_blank">
          <dl className={`${ratings?.metacritic_url ? 'hover:border-white/[.45] active:border-white/[.45]' : 'opacity-60'} rounded-lg border-4 border-white/[.2] h-full px-1 sm:px-2 bg-metacritic shadow overflow-hidden text-center flex items-center gap-1 sm:gap-2`}>
        ...
        <a className="" href={ratings?.rotten_tomatoes_url} target="_blank">
          <dl className={`${ratings?.rotten_tomatoes_url ? 'hover:border-white/[.45] active:border-white/[.45]' : 'opacity-60'} rounded-lg border-4 border-black/[.3] h-full px-1 sm:px-2 bg-rotten shadow overflow-hidden text-center flex items-center gap-1 sm:gap-2`}>
