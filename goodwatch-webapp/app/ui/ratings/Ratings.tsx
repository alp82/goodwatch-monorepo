			...
			>
				...
				>
					...
					>
						...
						<dt
							className={`truncate text-xs font-medium text-gray-700 ${ratings?.imdb_url && "underline"}`}
						>
							Score
						</dt>
					</dl>
					...
					>
						...
						<div className="flex justify-center gap-8">
							<div>
								...
								<dt
									className={`truncate text-xs font-medium text-gray-300 ${ratings?.metacritic_url && "underline"}`}
								>
									Metascore
								</dt>
							</div>
					...
					>
						...
						<div className="flex justify-center gap-8">
							<div>
								...
								<dt
									className={`truncate text-xs font-medium text-gray-100 ${ratings?.rotten_tomatoes_url && "underline"}`}
								>
									Tomatometer
								</dt>
							</div>
							<div>
								<dd className="mt-1 text-3xl font-semibold tracking-tight text-gray-50 no-underline">
