    ...
    <div id="tab-details-streaming">
        ...
        <div>
          ...
          <div className="flex flex-wrap gap-4">
            {flatrateLinks.map(link => {
              return (
                <a key={link.display_priority} href={link.stream_url} target="_blank" className="rounded-xl border-4 border-gray-600 hover:border-gray-500" rel="noreferrer">
                  <img
      ...
      {!hasNothing && (
        <div className="mt-12 w-auto h-3 flex gap-2 items-center">
          ...
          <a href={links[0].tmdb_url} target="_blank" className="" rel="noreferrer">
            <img alt="TMDB" className="h-3 w-auto" src={tmdb_logo} />
          </a>
          <small>and</small>
          <a href="https://justwatch.com" target="_blank" className="scale-150 ml-5" data-original="https://www.justwatch.com" rel="noreferrer">
