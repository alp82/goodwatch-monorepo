...
export default function FilterSelection({ show, params, updateParams, onClose }: FilterSelectionParams) {
                    ...
                    <div className="flex-1 text-gray-100">
                      ...
                      <div className="px-4 py-6 sm:px-6 sm:py-0 flex flex-col gap-2 sm:gap-6">
                        ...
                        <div>
                          ...
                          <div className="flex flex-wrap items-center justify-center gap-2 sm:gap-4">
                            <FilterGenres type={params.type} withGenres={params.withGenres} withoutGenres={params.withoutGenres} onChange={handleGenresChange} />
                          </div>
                        </div>
                          ...
                          <div className="flex flex-col flex-wrap items-center justify-center gap-2 sm:gap-4">
                            <div className="isolate inline-flex rounded-md shadow-sm">
                              <button
                                ...
                                onClick={() => handleYearChange(thisYear, thisYear)}
                              >
                                This Year
                              </button>
                              <button
                                ...
                                onClick={() => handleYearChange(thisYear-1, thisYear-1)}
                              >
                                Last Year
                              </button>
                              <button
                                ...
                                onClick={() => handleYearChange(thisYear-5, thisYear)}
                              >
                                Last 5 Years
                              </button>
                            </div>
                            ...
                            <div className="mt-1 flex gap-3 items-center">
                              ...
                              <NumberInput name="maxYear" placeholder="Max Year" value={maxYear || ''} onBlur={handleChange} onChange={(event) => setMaxYear(event.target.value)} />
                            </div>
                          </div>
                        </div>
