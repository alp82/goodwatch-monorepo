...
export type SortBy = 'most_recently_added' | 'least_recently_added' | 'highest_score' | 'most_popular'
...
export default function WishlistFilter({ filterByStreaming, onChange }: WishlistFilterProps) {
