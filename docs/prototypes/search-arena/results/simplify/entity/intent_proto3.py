...
EX = {
 "filmography": ["X movies", "X films", "films starring X", "movies directed by X", "X filmography", "X's best films",
                 ...
                 "shows created by X", "the X movie with the car chase", "Filme mit X", "les films de X", "películas de X"],
 "style": ["movies like X", "films similar to X", "in the style of X", "X-ish vibes", "reminds me of X",
           ...
           "as if X made it", "X inspired", "un film comme X", "im Stil von X", "al estilo de X"],
 "both": ["X", "X and films like theirs", "X plus similar picks"],
}
