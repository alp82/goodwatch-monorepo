...
class MovieProcessor(BaseProcessor):
    ...
    def __init__(self, arango_connector):
        ...
        self.initialize_batch_buffers([
            ...
            'languages', 'streaming_services', 'streaming_availability', 'scores',
            'persons', 'genres', 'keywords', 'tropes', 'dna', 'movie_series', 'production_companies'
        ])
    ...
    def process_item(self, item, id_prefix):
        ...
        # Process DNA
        self.dna_processor.process_dna(doc, item.get('dna'), 'movies')
